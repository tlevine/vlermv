...
# html_theme = 'default'
html_theme = 'dotted' #zzzeeksphinx' # bizstyle'
...
latex_documents = [
  ('index', 'vlermv.tex', u'vlermv Documentation',
   u'Thomas Levine', 'manual'),
]
...
man_pages = [
    ('index', 'vlermv', u'vlermv Documentation',
     [u'Thomas Levine'], 1)
]
...
texinfo_documents = [
  ('index', 'vlermv', u'vlermv Documentation',
   u'Thomas Levine', 'vlermv', 'One line description of project.',
   'Miscellaneous'),
]
